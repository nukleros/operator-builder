...
const DefaultBoilerplatePath = "hack/boilerplate.go.txt"

var _ machinery.Template = &Boilerplate{}

var (
	ErrUnknownLicense = errors.New("unknown specified license")
)
...
func (f *Boilerplate) Validate() error {
	if f.License == "" {
		...
		return fmt.Errorf("license %s, %w", f.License, ErrUnknownLicense)
	}
